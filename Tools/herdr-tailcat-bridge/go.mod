module herdr-tailcat-bridge

go 1.27.1

require github.com/missuo/herdrm/tailcat v0.0.0
...
require (
	...
	github.com/tailscale/tailcat v0.6.0 // indirect
...
replace github.com/missuo/herdrm/tailcat => ../../Packages/HerdrTailcat/go
